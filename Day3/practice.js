//객체 조작
// 1. 객체 편진 : 생성,복제,삭제,변경,추가

// $("요소선택").html()
// 선택한 요소의 하위 요소를 가져와 문자열로 반환 / 모두 제거하고 새 값으로 바꿀 떄
// console.log($("#section_1").html());
// $("#section_1").html(" <h3>하하하 20분으로 줄었다~^^^</h3> ");

// $("요소선택").text()
// 선택한 요소에 포함되어 있는 전체 텍스트를 가져옴!
// console.log($("#section_1").text());
// $("#section_1").text(" <p> 오 18분 남았다 </p>  ")

// $("요소선택").attr("속성명") : 선택한 요소의 속성 값을 가져옴
// const newImgSrc = 'https://pbs.twimg.com/media/Fpbh8lTXEAMdhKF?format=jpg&name=large'
// console.log($("img").attr("src",newImgSrc));
// $("img").removeAttr("alt")

// $("요소선택").attr("속성명","세값") : 선택한 요소의 속성 값을 교체 
